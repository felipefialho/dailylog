...
- [Day 01](https://github.com/LFeh/dailylog/blob/master/log/03-01-2016.md) `cash in your job` `cx` `creativity` `worst game of history` `lingerieday` `disinformation` `cook` `finances`
