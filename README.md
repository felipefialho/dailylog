...
- [Day 03](https://github.com/LFeh/dailylog/blob/master/log/06-03-2016.md) - Read: `css` `ux` / Did: `gym`
...
- [Day 23](https://github.com/LFeh/dailylog/blob/master/log/06-23-2016.md) - Read: `front-end` `ux` `work / motivation` / Did: `travel to americana` `gym` `bear`
...
- [Day 25](https://github.com/LFeh/dailylog/blob/master/log/08-25-2016.md) - Read: `front: css animation + motion curves` `work: find yourself?` `work: junk stats` Did: `meetupcss` `trip: campos do jordao`
...
- [Day 14](https://github.com/LFeh/dailylog/blob/master/log/09-14-2016.md) - Read: `front: color on the web` `front: resizeable components + relative units` Did: `gym` `english class`
